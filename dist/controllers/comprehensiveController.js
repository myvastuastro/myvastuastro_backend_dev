...
const comprehensiveService_1 = require("../services/comprehensiveService");
function createComprehensive(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const comprehensive = yield comprehensiveService_1.ComprehensiveService.createComprehensive(req.body);
            if (comprehensive) {
...
function getComprehensive(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const comprehensive = yield comprehensiveService_1.ComprehensiveService.getById(id);
            if (comprehensive) {
...
function updateComprehensive(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const comprehensive = yield comprehensiveService_1.ComprehensiveService.updateComprehensive(id, req.body);
            if (comprehensive) {
...
function deleteComprehensive(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const comprehensive = yield comprehensiveService_1.ComprehensiveService.deleteComprehensive(id);
            if (comprehensive) {
...
function getAllComprehensives(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const comprehensive = yield comprehensiveService_1.ComprehensiveService.getAll();
            if (comprehensive) {
                res.status(200).json({ message: 'Find successful', data: comprehensive, status: "success", statusCode: 200 });
            }
            else {
