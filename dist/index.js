...
const comprehensiveFreeCallRoutes_1 = __importDefault(require("./routes/comprehensiveFreeCallRoutes"));
const appointmentImportantCallRoutes_1 = __importDefault(require("./routes/appointmentImportantCallRoutes"));
const supportRoutes_1 = __importDefault(require("./routes/supportRoutes"));
const adminSupportRoutes_1 = __importDefault(require("./routes/adminSupportRoutes"));
const askQuestionVastuRoutes_1 = __importDefault(require("./routes/askQuestionVastuRoutes"));
...
app.use("/appointment", appointmentImportantCallRoutes_1.default);
app.use("/comprehensive", comprehensiveFreeCallRoutes_1.default);
app.use("/askQuestionvastu", askQuestionVastuRoutes_1.default);
