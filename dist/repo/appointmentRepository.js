...
class AppointmentRepository {
    ...
    static getAppointmentById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield appointmentModel_1.default.findById(id);
        });
    }
    static updateAppointment(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield appointmentModel_1.default.findByIdAndUpdate(id, { $set: Object.assign({}, data) }, { new: true });
            }
            catch (error) {
    ...
    static deleteAppointment(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield appointmentModel_1.default.deleteOne({ _id: id });
        });
    }
    static getAllAppointments() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield appointmentModel_1.default.find();
        });
    }
}
