...
class ComprehensiveRepository {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const parsedAvailability = typeof comprehensive === 'string'
                    ...
                    : comprehensive;
                const newComprehensive = yield comprehensiveFreeCallModel_1.default.create({
                    userId,
                    vastuAstrologerId,
    ...
    static getComprehensiveById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield comprehensiveFreeCallModel_1.default.findById(id);
        });
    }
    static updateComprehensive(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield comprehensiveFreeCallModel_1.default.findByIdAndUpdate(id, { $set: Object.assign({}, data) }, { new: true });
            }
            catch (error) {
    ...
    static deleteComprehensive(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield comprehensiveFreeCallModel_1.default.deleteOne({ _id: id });
        });
    }
    static getAllComprehensives() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield comprehensiveFreeCallModel_1.default.find().populate('userId')
