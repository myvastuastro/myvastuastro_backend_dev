...
const kundli_1 = __importDefault(require("../models/kundli"));
class KundliRepository {
    static createKundli(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield kundli_1.default.create(data);
            }
            catch (error) {
    ...
    static findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return kundli_1.default.find();
        });
    }
    static findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return kundli_1.default.findById(id).lean();
        });
    }
}
