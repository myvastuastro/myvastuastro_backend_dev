...
class NotificationRepository {
    static saveNotification(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield notificationModel_1.default.create(data);
        });
    }
    ...
    static getNotificationById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield notificationModel_1.default.findById(id);
        });
    }
    static updateNotification(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield notificationModel_1.default.findByIdAndUpdate(id, data, { new: true });
        });
    }
}
